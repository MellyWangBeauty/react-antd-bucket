...
import {Button, Card, Descriptions, Dropdown, Icon, Menu, message, Table} from "antd";
import {bucketFile, bucketFileDelete, bucketFileDownload} from "@/api/bucket";
...
class User extends Component {
    ...
    handleGoPage = (url) => {
        ...
        this.props.history.push(url + '?bucketId=' + row.bucketId + '&bucketName=' + row.bucketName + '&authority=' + row.authority)
    };
