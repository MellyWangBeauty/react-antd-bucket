            ...
            <div className="app-container">
                ...
                <Card title={title}>
                    <Table bordered rowKey="id" dataSource={bucket} pagination={false}>
                        ...
                        <Column title="空间类型" dataIndex="type" key="type" align="center"  render={(type, record, index) => {
                            let _typeMap = ['标准型','低访问','高访问'];
                        ...
                        <Column title="创建时间" dataIndex="createTime" key="createTime" align="center"  render={(createTime, record, index) => {
                            return createTime
                        }}/>
