...
import { reqUserInfo, deleteUser, editUser, addUser } from "@/api/user";
  ...
  render() {
    ...
    return (
      <div className="app-container">
          ...
          <Form {...formItemLayout} name="form" 
            ...
            <Form.Item label="邮箱" >
              ...
              <Button
                type="primary"
                style={{ marginLeft: 10 + 'px' }}
                onClick={this.handleChangeEmail.bind(null,'email')}
              >
                更改
              </Button>
            </Form.Item>
            <Form.Item label="密码" name="password">
              ...
              <Button
                type="primary"
                style={{ marginLeft: 10 + 'px' }}
                onClick={this.handleChangeEmail.bind(null,'pass')}
              >
                更改
              </Button>
            </Form.Item>
        ...
        <Card style={{marginTop:10+'px'}} title={title2} className="person">
          <Form {...formItemLayout}>
            <Form.Item >
              <Button
                type="primary"
        ...
        <Card style={{marginTop:10+'px'}} title={title3} className="person">
          <Form {...formItemLayout}>
            <Form.Item >
              <Button
                type="primary"
        ...
        />
        <ChangeEmailForm
          wrappedComponentRef={formRef => this.changeChangeEmailRef = formRef}
...
// export default User;
export default connect(mapStateToProps, { logout, getUserInfo })(Form.create({ name: "User" })(User));
